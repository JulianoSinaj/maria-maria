...
/* Produkt-Landingpage im Apple-Stil für den Rosato Negroamaro IGP Salento.
   Nutzt exakt dieselben Sektionen wie die Falanghina-Seite — nur die
   wineData-Datei ist eine andere. */

const wine = ROSATO_NEGROAMARO;

export const metadata = {
  title: "Rosato Negroamaro IGP Salento — Maria Maria",
...
export default function RosatoNegroamaroPage() {
  return (
    <>
      <ProductJsonLd />
