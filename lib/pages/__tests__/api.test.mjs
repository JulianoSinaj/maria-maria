...
/* Die Sitzung wird hier selbst gebaut statt über lib/admin/session
   importiert: dessen relative Importe tragen (Hausstil) keine Dateiendung,
   was Webpack auflöst und der ESM-Loader von Node nicht. Format:
   <expiry>.<base64url payload>.<base64url HMAC-SHA256> — siehe createSession(). */
...
if (secret) H.Cookie = `mm_admin=${mintSession(secret)}`;
