/* Rechtstexte: Impressum, Datenschutzerklärung, AGB.
   ...
   Widerrufsbelehrung ist schlimmer als gar keine. */
...
export const legal = {
    ...
    sections: [
      {
        ...
        body: [
          ...
          "Elberfelder strasse 78d, 40822 Mettmann, Deutschland",
  ...
  datenschutz: {
    ...
    intro:
      "Der Schutz Ihrer persönlichen Daten ist uns wichtig. Hier erfahren Sie, welche Daten wir zu welchem Zweck verarbeiten — so knapp und verständlich wie möglich.",
    sections: [
      {
        title: "1. Verantwortlicher",
        body: [
          "Verantwortlich für die Datenverarbeitung auf dieser Website ist die Maria Maria Wines GmbH, Elberfelder strasse 78d, 40822 Mettmann, Deutschland, E-Mail: info@maria-maria.de.",
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          "Ihre Sprachwahl wird in einem technisch notwendigen Cookie (mm_locale) gespeichert, damit die Seite Sie beim nächsten Besuch in der gewählten Sprache begrüßt. Es enthält ausschließlich das Sprachkürzel und dient nicht der Wiedererkennung Ihrer Person.",
        ],
      },
      {
        title: "7. Ihre Rechte",
