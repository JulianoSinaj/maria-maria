...
ok(byPath["/img/home/hero-mare-1280.webp"]?.category === "lifestyle", "Reben-und-Meer hero → lifestyle");
...
console.log("\nRESTORE:");
r = await PUT(`${HOST}/api/admin/hero`, { image: { src: "/img/home/hero-mare-1280.webp", focus: { x: 76, y: 45 } } });
