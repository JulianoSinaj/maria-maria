...
> The former `terracotta` / `terracotta-outline` variants (Kontakt-Handoff
> 18.08.2026) were removed on 20.08.2026 — /kontakt now uses `primary` and
> `outline` like the rest of the storefront.
