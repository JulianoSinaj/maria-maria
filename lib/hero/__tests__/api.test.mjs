...
ok(d.image.src === "/img/home/hero-mare-1280.webp" && d.image.focus.x === 76 && d.image.focus.y === 45,
   "default is the live Reben-und-Meer hero at its real 76/45 anchor");
...
ok(r.b.data.images.some((i) => i.name === "hero-mare-1280.webp") &&
...
ok(r.s === 200, "library-wide assignment: a wine packshot is a legal hero background");
r = await PUT({ image: { src: "/video/intro.mp4" } });
ok(r.s === 422, "path outside the media library → 422");
...
ok(r.b.data.config.image.focus.x === 30 && r.b.data.config.image.focus.y === 45,
...
r = await PUT({ image: { src: "/img/home/hero-mare-1280.webp", focus: { x: 76, y: 45 } },
...
ok(r.s === 200 && r.b.data.config.image.src === "/img/home/hero-mare-1280.webp" &&
