...
const CATALOGUE = [
  { slug: "primitivo-15-5", name: "Primitivo di Manduria D.O.C. 15,5", region: "Apulien", variant: "redsoft", type: "Rotwein", price: 16.9, year: 2020, notes: "Intensiv, kraftvoll und ausgewogen", pairing: "Zu geschmortem Fleisch, Wild und gereiftem Käse.", dot: "#6B0F1A" },
  { slug: "lugana", name: "Lugana D.O.P.", region: "Gardasee", variant: "white", type: "Weißwein", price: 14.9, year: 2023, notes: "Elegant, frisch und mineralisch", pairing: "Ideal zu Fisch, Pasta mit Pesto oder hellem Fleisch.", dot: "#C8B77A" },
  ...
  { slug: "primitivo-14-5", name: "Primitivo di Manduria D.O.C. 14,5", region: "Apulien", variant: "red", type: "Rotwein", price: 12.9, year: 2021, notes: "Weich, vollmundig und harmonisch", pairing: "Ideal zu Pasta, Grillgerichten und reifem Käse.", dot: "#6B0F1A" },
  ...
  { slug: "falanghina", name: "Falanghina I.G.P.", region: "Kampanien", variant: "white", type: "Weißwein", price: 13.9, year: 2023, notes: "Frisch, fruchtig und lebendig", pairing: "Perfekt zum Aperitivo, zu Meeresfrüchten oder Salaten.", dot: "#C8B77A" },
