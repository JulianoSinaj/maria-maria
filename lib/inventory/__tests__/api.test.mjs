...
for (const [q, expect, label] of [
  ...
  ["?region=Kampanien", 4, "region=Kampanien → 4 (incl. Il Rosso/Irpinia)"],
...
/* Il Rosso was re-provenanced to Kampanien (Irpinia) — three regions remain */
ok(r.b.data.regions.length === 3, `facets.regions ${JSON.stringify(r.b.data.regions)}`);
