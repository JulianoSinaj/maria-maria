...
const FALLBACK_URL = "https://maria-maria.de";
...
/* Das Standard-Teaserbild für Seiten ohne eigenes Motiv — und damit die
   Karte für maria-maria.de selbst: die Wortmarke, schwarz auf Weiß, kein
   Foto. Ohne dieses Bild rendert Twitter/X die Karte trotz
   `summary_large_image` als schmale Textzeile und LinkedIn zeigt gar nichts —
   bei geteilten Links kostet das unmittelbar Klicks. Erzeugt von
