...
export function organizationNode({ description } = {}) {
  return {
    ...
    /* Telefon nur, wenn eine bestätigte Nummer hinterlegt ist (lib/site.js).
       Ein leerer oder erfundener Wert im Markup wäre schlimmer als keiner:
       Google zeigt ihn als Firmennummer an. */
    ...(BUSINESS.phone ? { telephone: BUSINESS.phone } : null),
    contactPoint: {
      "@type": "ContactPoint",
