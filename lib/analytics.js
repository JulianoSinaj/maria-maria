...
/* Klick auf den primären CTA des Maria-Maria-Moments, der seit 08/2026
   nicht mehr in den Shop, sondern ins Food-Pairing-Kapitel des Magazins
   führt (/magazin?anlass=…#food-pairing). Nutzlast: `wine_name` und
   `anlass` (Schlüssel der geöffneten Antwort-Karte). */
export const PAIRING_MAGAZIN_CLICK = "pairing_magazin_click";
