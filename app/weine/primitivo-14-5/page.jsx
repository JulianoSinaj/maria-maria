import { PRIMITIVO_14_5 } from "@/components/weine/primitivo-14-5/wineData";
...
/* Produkt-Landingpage im Apple-Stil für den Primitivo di Manduria DOP 14,50.
   Nutzt exakt dieselben Sektionen wie die Falanghina-Seite — nur die
   wineData-Datei ist eine andere. */

const wine = PRIMITIVO_14_5;

export const metadata = {
  title: "Primitivo di Manduria DOP 14,50 — Maria Maria",
...
export default function Primitivo145Page() {
  return (
    <>
      <ProductJsonLd />
