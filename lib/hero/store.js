/* Homepage-hero content config.
   ...
   image.focus mirrors HomeHeroPhoto's object-position (76% 45%: bottle
   and glass stay in frame on portrait crops while vines and sea may
   leave the cut).
...
export function defaultHeroConfig() {
  return {
    image: {
      src: "/img/home/hero-mare-1280.webp",
      focus: { x: 76, y: 45 },
    },
    copy: {
